...
| **A2.2** | 🟡 **Language toggle**: Page has a ZH/EN toggle. Switches displayed text between Chinese and English columns from the Sheet. URL can include `&lang=en` or `&lang=zh` so agent can send a language-appropriate link. | |
...
| **A4** | **Messaging CTA**: Fixed bottom bar with LINE and WhatsApp buttons. LINE opens `https://line.me/ti/p/~{LINE_ID}`. WhatsApp opens `https://wa.me/{PHONE}`. Both configured once in the HTML (same contact for all properties). | |
...
| Part | | R0 | R1 | R2 | R3 | R4 | R5 | R6 | R7 | R8 |
|------|------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
